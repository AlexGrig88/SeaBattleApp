...
- Игра по сети предоставляет ip адрес текущей сети для обоих игроков, после чего можно совершать игру с другом (используется синхронный режим с блокировками консоли для SeaBattleApp)\
 \
