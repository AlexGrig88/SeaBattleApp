...
- Умный алгоритм работы компьютера
- Отслеживание и Сохранение статистики игры в папке Документы пользователя (для ОС Windows)
- Возможность игры с другом по локальной сети: программа запрашивает и отображает ip адрес для компьютера игрока, после чего можно совершать игру с другом (для CLI - используется синхронный режим с блокировками консоли)\
 \
